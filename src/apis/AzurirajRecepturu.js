...
const AzurirajRecepturu = ({props,role})=>{
    ...
    },[URL,props.token,role.rola_1,role.rola_2,role.rola_3,role.user ]);
    ...
    return(
        <div>
            {errorMesagges ==='' ?
                ...
                {list === 1 ? <AzuriajRecKolac role={role} token={props.token} props={{idKolaca,imeKolaca}} /> : null}
             </div>:
